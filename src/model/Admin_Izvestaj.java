...
public class Admin_Izvestaj extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8717211870618018774L;
	
		Color col = new Color(255, 134, 123);
		Color colPolje = new Color(255, 178, 171);
		
	public Admin_Izvestaj() throws IOException  {
		...
		dug5.setForeground(new Color(255, 255, 255));
